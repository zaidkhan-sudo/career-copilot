...
interface LiquidMetalIconBadgeProps {
  icon: React.ReactNode;
  size?: number;
}
            ...
            {viewMode === "text" && (
              <span
                style={{
                  ...
                  fontWeight: 500,
                  textShadow: "0px 0px 12px rgba(255, 255, 255, 0.22)",
                  transition: "all 0.8s cubic-bezier(0.34, 1.56, 0.64, 1)",
                  transform: "scale(1)",
                  whiteSpace: "nowrap",
                }}
...
export function LiquidMetalIconBadge({ icon, size = 44 }: LiquidMetalIconBadgeProps) {
  const inner = Math.max(size - 4, 36);
